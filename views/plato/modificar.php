						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <input type="hidden" name="id_plato" value="<?php echo isset($id_plato) ? $id_plato: "" ?>">
									<input type="text" class="form-control" placeholder="Nombre de Plato" name="txtNombre" value="<?php echo isset($nombre_plato) ? $nombre_plato : "" ?>">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="">Descripcion <span class="text-danger">(*)</span></label>
									<input type="text" class="form-control" placeholder="Descripción de categoria" name="txtDescripcion" value="<?php echo isset($descripcion_plato)? $descripcion_plato : "" ?>">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" class="form-control" placeholder="Precio de plato" name="txtPrecio" value="<?php echo isset($precio_plato) ? $precio_plato : "" ?>">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="file" class="form-control" placeholder="Foto de Plato" name="txtFoto" accept="image/*" value="<?php echo isset($foto_plato) ? $foto_plato : "" ?>">
