		...
		<div class="row d-flex no-gutters">
			<div class="col-md-12 order-md-last ftco-animate makereservation p-4 p-md-5 pt-5">
				<div class="py-md-5">
					...
					<form method="POST" action="<?php echo "index.php?c=" . seg::codificar("usuario") . "&m=" . seg::codificar("modificar") ?>" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="">Logo de Restaurante (200x200px) <span class="text-danger"></span></label>
									<input type="file" class="form-control" placeholder="URL de Logo de restaurnate (200x200 px)" name="imgLogo" value="<?php echo isset($resultados["logo_empresa"]) ? $resultados["logo_empresa"] : "" ?>" accept="image/*">
									<span class="text-danger"><?php echo isset($error[4]) ? $error[1] : "" ?></span>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="">Imagen de Fondo (800x800px)<span class="text-danger"></span></label>
									<input type="file" class="form-control" placeholder="URL de Logo de iamgen de fondo  (800x800 px)" name="imgFondo" value="<?php echo isset($resultados["imagen_fondo"]) ? $resultados["imagen_fondo"] : "" ?>" accept="image/*">
									<span class="text-danger"><?php echo isset($error[4]) ? $error[1] : "" ?></span>
								</div>
							</div>
